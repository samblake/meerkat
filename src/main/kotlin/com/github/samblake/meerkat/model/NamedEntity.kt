...
abstract class NamedEntityClass<out E:NamedEntity<out Any>>(val name: String, val urlSegment: String, table: IdTable<Int>, entityType: Class<E>? = null) : IntEntityClass<E>(table, entityType) {
}
